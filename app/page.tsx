  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 h-80"> {/* Фиксированная высота для сетки */}
          {/* Карточка 1 - Управление продуктами */}
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
